...
/**
 * @xmlonly <manual name="GetTrigger" label="riscv_irq_controlgettrigger"/> @endxmlonly
...
#if defined(CONFIG_KERNEL_MCS)
/**
 * @xmlonly <manual name="ConfigureFlags" label="schedcontrol_configureflags"/> @endxmlonly
