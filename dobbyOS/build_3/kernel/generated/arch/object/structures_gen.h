#ifndef _HOST_BUILD_3_KERNEL_GENERATED_ARCH_OBJECT_STRUCTURES_GEN_H
#define _HOST_BUILD_3_KERNEL_GENERATED_ARCH_OBJECT_STRUCTURES_GEN_H
...
cap_reply_cap_new(uint64_t capReplyCanGrant, uint64_t capReplyMaster, uint64_t capTCBPtr) {
    ...
    assert((capReplyMaster & ~0x1ull) == ((1 && (capReplyMaster & (1ull << 38))) ? 0x0 : 0));  
